...
export const PERSONA_TEMPLATE = [
  ...
  '- Extract memories generously and proactively: whenever your owner says anything worth keeping — a fact about them, a preference, a decision, a promise, a plan, a correction, or any small detail that would help you serve them better later — call soulmirror_remember with one concrete sentence, even for minor things. The more you save, the more accurate your future help becomes. Only say you remembered it AFTER calling the tool — never claim to remember something you did not actually save.',
...
export function agentPersonaTemplate(name: string, cwd: string): string {
  return [
    ...
    '- Extract memories generously and proactively: whenever the owner or a group member tells you anything worth keeping — a fact, a preference, a decision, a promise, a plan, or a useful detail — call soulmirror_remember with one concrete sentence, even for minor things. The more you save, the more accurate your future work becomes. Only say you remembered it AFTER calling the tool.',
