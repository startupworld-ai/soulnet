...
- Do not test against the public relay `relay.startupworld.cn` with traffic that could affect other users; run your own relay (`cmd/soulnet-relay`) for research.
